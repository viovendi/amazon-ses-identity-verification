import { handler } from '../../src/actions/checkIfDnsForDomainIsProperlyConfigured';

// TODO #1: Rename xit() to it() to enable the test.
// TODO #2: Change the test name below to match your use case.
xit('should verify if the checkIfDnsForDomainIsProperlyConfigured action works as expected', async () => {
